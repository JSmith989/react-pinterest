    ...
    <div>
      <Navbar color='dark' dark expand='md' className='justify-content-between'>
        ...
        <Collapse isOpen={isOpen} navbar>
          ...
          Only use this if you know your props are correct and need time to load. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Optional_chaining */}
          {
            user
            && <>
